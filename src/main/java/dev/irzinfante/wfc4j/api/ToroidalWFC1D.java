 ...
 * @since	1.0.0
 */
final public class ToroidalWFC1D<T> extends AbstractWFC1D<T> {
	 ...
	 * @since	1.0.0
	 */
	public ToroidalWFC1D(TileMap1D<T> tileMap, int gridSizeX) throws TileException, DimensionException {

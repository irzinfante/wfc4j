...
public class TileMap2D<T> {
	...
	/**
	 * Creates a 2-dimensional tilemap with the given tileset
	 *
	 ...
	 * @since	0.2.0
	 */
	public TileMap2D(Set<Tile<T>> tileSet) throws TileException {
		...
		tileSet.forEach(tile -> {
			this.adjacents.put(tile, (Set<Tile<T>>[]) new HashSet<?>[4]);
		});
	}
	 ...
	 * @since	0.2.0
	 */
	public Set<Tile<T>> getAdjacents(Tile<T> tile, Side2D side) throws TileException {
	 ...
	 * @since	0.2.0
	 */
	public boolean addAdjacent(Tile<T> tile, Side2D side, Tile<T> adjacent) throws TileException {
